...
CIMGUI_API ImPlotAxisState* ImPlotAxisState_ImPlotAxisStatePlotAxisPtr(ImPlotAxis* axis,bool has_range,ImGuiCond range_cond,bool present)
{
    return IM_NEW(ImPlotAxisState)(axis,has_range,range_cond,present);
}
CIMGUI_API void ImPlotAxisState_destroy(ImPlotAxisState* self)
{
    IM_DELETE(self);
}
CIMGUI_API ImPlotAxisState* ImPlotAxisState_ImPlotAxisStateNil(void)
{
    return IM_NEW(ImPlotAxisState)();
}
CIMGUI_API ImPlotAxisColor* ImPlotAxisColor_ImPlotAxisColor(void)
{
    return IM_NEW(ImPlotAxisColor)();
}
CIMGUI_API void ImPlotAxisColor_destroy(ImPlotAxisColor* self)
{
    IM_DELETE(self);
}
...
CIMGUI_API ImPlotAxisScale* ImPlotAxisScale_ImPlotAxisScale(int y_axis,float tx,float ty,float zoom_rate)
{
    return IM_NEW(ImPlotAxisScale)(y_axis,tx,ty,zoom_rate);
}
CIMGUI_API void ImPlotAxisScale_destroy(ImPlotAxisScale* self)
{
    IM_DELETE(self);
}
...
CIMGUI_API void ImPlot_UpdateAxisColors(int axis_flag,ImPlotAxisColor* col)
{
    return ImPlot::UpdateAxisColors(axis_flag,col);
}
...
CIMGUI_API void ImPlot_ShowAxisContextMenu(ImPlotAxisState* state,bool time_allowed)
{
    return ImPlot::ShowAxisContextMenu(*state,time_allowed);
}
